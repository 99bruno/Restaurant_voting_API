...
class MenuViewTests(APITestCase):
    def setUp(self):
        ...
        self.restaurant = Restaurant.objects.create(
            name="Test Restaurant", owner_id=self.admin_user
        )
    ...
    def test_create_menu_as_admin(self):
        ...
        response = self.client.post(
            f"/restaurants/{self.restaurant.id}/menu/", data, format="json"
        )
    ...
    def test_get_menu_for_restaurant(self):
        self.client.force_authenticate(user=self.admin_user)
        Menu.objects.create(restaurant=self.restaurant, date="2024-12-10")
    ...
    def test_create_menu_for_nonexistent_restaurant(self):
        ...
        response = self.client.post("/restaurants/9999/menu/", data, format="json")
